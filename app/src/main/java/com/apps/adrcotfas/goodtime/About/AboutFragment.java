...
public class AboutFragment extends MaterialAboutFragment {
    ...
    protected MaterialAboutList getMaterialAboutList(@NonNull Context c) {
        ...
        builder1.addItem(new MaterialAboutActionItem.Builder()
                ...
                .icon(new IconicsDrawable(c)
                        ...
                        .sizeDp(18))
                .setOnClickAction(() -> {
                    Intent i = new Intent(getActivity(), MainIntroActivity.class);
                    startActivity(i);
                })
                .build());
    ...
    public void onResume() {
        ...
        ((AboutActivity) getActivity()).updateTitle(R.string.mal_title_about);
    }
    ...
    private void openFeedback() {
        ...
        try {
            ...
            Toast.makeText(getContext(), R.string.about_no_email, Toast.LENGTH_SHORT).show();
        }
    }
}
